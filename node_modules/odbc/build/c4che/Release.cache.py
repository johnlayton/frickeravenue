...
CPPPATH_NODE = '/home/john/.nvm/v0.8.0/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
LIBDIR = '/home/john/.node_libraries'
LIBPATH_NODE = '/home/john/.nvm/v0.8.0/lib'
LIBPATH_ODBC = ['/usr/local/lib', '/opt/local/lib', '/opt/local/lib']
LIBPATH_ST = '-L%s'
LIB_ODBC = ['odbc']
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/home/john/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/home/john/.nvm/v0.8.0'
